...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addIntegerOption(option => option.setName('seconds').setDescription('Provide the amount of time you want to forward the song!').setRequired(true).setMinValue(0)),
    global: true,
    async execute(interaction, client, args) {
        ...
        try {
            ...
            embed.setColor("Orange").setDescription(`Forwarded the song for \`${seconds}s\` ⏩`);
